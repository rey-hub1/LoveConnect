            ...
            {!currentQuestion ? (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Home size={32} className="opacity-80 md:hidden" />
                      <Home size={40} className="opacity-80 hidden md:block" />
                    </motion.div>
                    <div>
                    ...
                    {isLoading ? (
                      ...
                      >
                        {mode === 'casual' ? (
                          ...
                          <Home size={48} className="text-purple-500 drop-shadow-[0_0_10px_rgba(168,85,247,0.5)]" />
                        ) : (
